...
MUZE.Audio = {
  ...
  async init() {
    ...
    try {
      ...
      // Fire-and-forget: the unlock fires within the gesture either way, and
      // NOT awaiting prevents a never-resolving play() promise from wedging
      // startup (seen in some headless/automated browsers).
      sa.play().catch(() => {});
    } catch (e) { /* OK */ }
